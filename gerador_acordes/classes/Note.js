...
const guitarSrc = (function() {
    // Resolve the assets path relative to where this script file actually lives,
    // instead of relative to the page that includes it. This way the audio works
    // whether Note.js is loaded from gerador_acordes/index.html directly or from
    // a page elsewhere on the site (e.g. /gera_acordes.php) that includes it as
    // "./gerador_acordes/classes/Note.js".
    const scriptEl = document.currentScript;
    if (scriptEl && scriptEl.src) {
        return new URL("../assets/guitar/", scriptEl.src).href;
    }
    return "assets/guitar/";
})();
